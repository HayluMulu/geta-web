  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-end gap-3 flex-row-reverse">
      <motion.a
        ...
        className="w-14 h-14 md:w-[56px] md:h-[56px] rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:shadow-xl hover:shadow-[#25D366]/40 transition-shadow flex-shrink-0"
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="card-cosmic px-4 py-2.5 rounded-xl text-sm text-foreground max-w-[200px] mb-2"
          >
