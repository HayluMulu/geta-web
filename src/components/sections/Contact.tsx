        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <form className="space-y-5">
              ...
              <Button variant="cosmic" size="lg" className="w-full h-14 text-lg font-bold">
                שלחו הודעה
              </Button>
            </form>
          </motion.div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="hidden lg:flex flex-col gap-10 pr-8"
          >
            <div className="space-y-8">
              <h3 className="text-xl font-bold text-foreground">דרכים נוספות ליצירת קשר:</h3>
              ...
              <div className="grid grid-cols-1 gap-8">
                ...
                <a href="https://wa.link/ofhnmb" target="_blank" rel="noreferrer" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-foreground font-medium group-hover:text-[#25D366] transition-colors">שלחו הודעה</p>
                  </div>
                </a>
                ...
                <a href="tel:0556874515" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-foreground font-medium group-hover:text-primary transition-colors">055-687-4515</p>
                  </div>
                </a>
