...
const Contact = () => {
  return (
    <section id="contact" className="relative py-24 px-6 scroll-mt-20 overflow-hidden section-veil">
      <ScrollDriftText text="FINAL CUT · LEAD · SHOW ·" speed={0.3} className="opacity-60" />
      ...
      <div className="max-w-[1100px] mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-foreground-muted text-lg">
            אני כאן כדי לעזור לכם להפוך כל רעיון לתוכן שמושך את העין (ומביא לידים).
            השאירו פרטים, נקבע לשיחה ונתחיל לתכנן את הפרויקט הבא שלכם.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div
            ...
            className="card-cosmic card-spotlight p-6 md:p-8 border-primary/20"
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs tracking-[0.2em] text-foreground-muted font-display" dir="ltr">
                ROLL CAMERA
              </span>
            </div>
            <ContactForm />
