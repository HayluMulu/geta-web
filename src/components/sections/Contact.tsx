...
const Contact = () => {
  return (
    <section className="relative py-24 px-6">
     ...
     {/* Contact Info */}
{/* Contact Info - Grid Layout: 2 Columns */}
<div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10 mb-12 lg:mb-0">
  
  {/* Column 1: Phone & Email */}
  <div className="space-y-8">
    {/* Phone */}
    <a href="tel:0556874515" className="flex items-center gap-4 group">
      ...
      <div>
        ...
        <p className="text-foreground font-medium group-hover:text-primary transition-colors text-left" dir="ltr">055-687-4515</p>
      </div>
    </a>

    {/* Email */}
    <a href="mailto:getashow123@gmail.com" className="flex items-center gap-4 group">
      <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-all">
        <Mail className="w-6 h-6 text-primary" />
      </div>
      <div>
        <p className="text-sm text-foreground-muted">אימייל</p>
        <p className="text-foreground font-medium group-hover:text-primary transition-colors">getashow123@gmail.com</p>
      </div>
    </a>
  </div>

  {/* Column 2: Instagram & WhatsApp */}
  <div className="space-y-8">
    {/* Instagram */}
    <a href="https://katzr.net/5e0c54" target="_blank" rel="noreferrer" className="flex items-center gap-4 group">
      ...
      <div>
        <p className="text-sm text-foreground-muted">אינסטגרם</p>
        <p className="text-foreground font-medium group-hover:text-[#E4405F] transition-colors">@geta_show</p>
      </div>
    </a>

    {/* WhatsApp */}
    <a href="https://wa.link/ofhnmb" target="_blank" rel="noreferrer" className="flex items-center gap-4 group">
      ...
      <div>
        <p className="text-sm text-foreground-muted">וואטסאפ</p>
        <p className="text-foreground font-medium group-hover:text-[#25D366] transition-colors">שלחו הודעה מהירה</p>
      </div>
    </a>
  </div>
</div>
          ...
          >
            <form className="space-y-5">
              ...
              <Button variant="cosmic" size="lg" className="w-full h-14">
                שלחו הודעה
              </Button>
            </form>
          </motion.div>
