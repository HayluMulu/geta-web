...
const services = [
  {
    ...
    description: "אנחנו בונים את המעטפת המלאה – מהקריאייטיב ועד לסרטון שגורם לאנשים לעצור את הגלילה.",
  },
  {
    icon: Camera,
    title: "צילום מקצועי (הסטייל)",
    description: "שימוש בציוד הקצה המתקדם ביותר כדי להעניק למותג שלכם מראה יוקרתי, חד ובלתי נשכח.",
  },
  {
    icon: Wand2,
