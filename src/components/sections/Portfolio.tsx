...
const Portfolio = () => {
  // Always call the hook (it handles mobile internally)
  const { elementRef: audioSectionRef } = useAudioInView({
    audioSrc: '/assets/music.mp3',
    startTime: 116, // 1:51 in seconds
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <motion.div
                  ...
                  whileHover={{ scale: 1 }}
                  className="w-16 h-16 rounded-full bg-primary/20 md:backdrop-blur-sm border border-primary/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                >
