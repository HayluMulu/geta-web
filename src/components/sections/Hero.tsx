  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-24">
      <div className="container relative z-10 text-center">
        ...
        >
          <span className="text-foreground">יוצרים</span>
          <br />
          <span className="text-gradient-cosmic">תוכן שמדבר</span>
        </motion.h1>
        ...
        >
          אנחנו סטודיו להפקות וידאו מקצועיות. מרעיון ועד למסך — 
          אנחנו מספרים את הסיפור שלכם בצורה שלא תישכח.
        </motion.p>
